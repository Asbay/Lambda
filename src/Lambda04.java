...
public class Lambda04 {
    ...
    */
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println(matBölümSayisi(unv));
        System.out.println();
        System.out.println(ogrcSayisi5500denBykMaxNotOrt(unv));
        System.out.println();
        System.out.println(ogrcSayisi1050denKckMinNotOrt(unv));
    }
    ...
    public static boolean notOrt74BykUnv(List<Universite> unv) {
        return unv.
                stream(). // akış sağladık   universiteler  u01, u02,u03,u04,u05 geldi akisa
    ...
    public static int matBölümSayisi(List<Universite> unv) {

        return (int) unv.stream().
                filter(t -> t.getBolum().contains("mat")).  //bölümü mat olan üni leri sectik
                count();                                    // secilen üni sayisini almak icin count() kullandik
    }

    //task 05-->Ogrenci sayilari 550'dan fazla olan universite'lerin en buyuk notOrt'unu bulunuz.
    public static OptionalInt ogrcSayisi5500denBykMaxNotOrt(List<Universite> unv) {
    ...
    public static OptionalInt ogrcSayisi1050denKckMinNotOrt(List<Universite> unv) {

        return unv.stream().
                filter(t -> t.getOgrSayisi() < 5500).
