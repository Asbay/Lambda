...
*/
        ...
        System.out.println("\n++++++++++++++");
        printCiftOtuzDörttenKckFunctional(sayi);
        System.out.println("\n++++++++++++++");
    ...
    public static void printElFunctional1(List<Integer> sayi){
        //bu print hazir methoddu ama arada bosluk birakmadi ardarda bitisik yazdi o yüzden kenidmiz bi methos olusturup onu cagiricaz

        sayi.stream().forEach(System.out:: print);    // method referance
    }
    //kendimiz bir method olusturalim ve bunu cagiralim
   ...
   //TASK :functional Programming ile list elemanlarinin 34 den kucuk cift olanlarini ayni satirda aralarina bosluk birakarak print ediniz.
    ...
    public static void printCiftOtuzDörttenKckFunctional(List<Integer> sayi){

        sayi.stream().filter(t -> t% 2 ==0).filter(t ->t < 34).forEach(Lambda01 :: yazdir);
    }
